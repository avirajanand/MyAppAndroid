 ...
 */
public class PlayTangSignupFragment extends PlayTangLoginFragmentBase implements OnClickListener {
  public static final String USERNAME = "com.parse.ui.PlayTangSignupFragment.USERNAME";
  public static final String PASSWORD = "com.parse.ui.PlayTangSignupFragment.PASSWORD";
  ...
  private static final String LOG_TAG = "PlayTangSignupFragment";
  private static final int DEFAULT_MIN_PASSWORD_LENGTH = 6;
  private static final String USER_OBJECT_NAME_FIELD = "name";
  private static final String USER_OBJECT_EMAIL_FIELD = "email";

  public static PlayTangSignupFragment newInstance(Bundle configOptions, String username, String password) {
    PlayTangSignupFragment signupFragment = new PlayTangSignupFragment();
    Bundle args = new Bundle(configOptions);
    args.putString(PlayTangSignupFragment.USERNAME, username);
    args.putString(PlayTangSignupFragment.PASSWORD, password);
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup parent,
    ...
    config = PlayTangLoginConfig.fromBundle(args, getActivity());
