...
/**
 * Configurations for the PlayTangLoginActivity.
 */
public class PlayTangLoginConfig {
  public static final String APP_LOGO = "com.playtang.commonnavigation.login.PlayTangLoginActivity.APP_LOGO";
  public static final String PARSE_LOGIN_ENABLED = "com.playtang.commonnavigation.login.PlayTangLoginActivity.PARSE_LOGIN_ENABLED";
  public static final String PARSE_LOGIN_BUTTON_TEXT = "com.playtang.commonnavigation.login.PlayTangLoginActivity.PARSE_LOGIN_BUTTON_TEXT";
  public static final String PARSE_SIGNUP_BUTTON_TEXT = "com.playtang.commonnavigation.login.PlayTangLoginActivity.PARSE_SIGNUP_BUTTON_TEXT";
  public static final String PARSE_LOGIN_HELP_TEXT = "com.playtang.commonnavigation.login.PlayTangLoginActivity.PARSE_LOGIN_HELP_TEXT";
  public static final String PARSE_LOGIN_INVALID_CREDENTIALS_TOAST_TEXT = "com.playtang.commonnavigation.login.PlayTangLoginActivity.PARSE_LOGIN_INVALID_CREDENTIALS_TEXT";
  public static final String PARSE_LOGIN_EMAIL_AS_USERNAME = "com.playtang.commonnavigation.login.PlayTangLoginActivity.PARSE_LOGIN_EMAIL_AS_USERNAME";
  public static final String PARSE_SIGNUP_MIN_PASSWORD_LENGTH = "com.playtang.commonnavigation.login.PlayTangLoginActivity.PARSE_SIGNUP_MIN_PASSWORD_LENGTH";
  public static final String PARSE_SIGNUP_SUBMIT_BUTTON_TEXT = "com.playtang.commonnavigation.login.PlayTangLoginActivity.PARSE_SIGNUP_SUBMIT_BUTTON_TEXT";
  public static final String FACEBOOK_LOGIN_ENABLED = "com.playtang.commonnavigation.login.PlayTangLoginActivity.FACEBOOK_LOGIN_ENABLED";
  public static final String FACEBOOK_LOGIN_BUTTON_TEXT = "com.playtang.commonnavigation.login.PlayTangLoginActivity.FACEBOOK_LOGIN_BUTTON_TEXT";
  public static final String GMAIL_LOGIN_BUTTON_TEXT = "com.playtang.commonnavigation.login.PlayTangLoginActivity.FACEBOOK_LOGIN_BUTTON_TEXT";
  public static final String FACEBOOK_LOGIN_PERMISSIONS = "com.playtang.commonnavigation.login.PlayTangLoginActivity.FACEBOOK_LOGIN_PERMISSIONS";
  public static final String TWITTER_LOGIN_ENABLED = "com.playtang.commonnavigation.login.PlayTangLoginActivity.TWITTER_LOGIN_ENABLED";
  public static final String TWITTER_LOGIN_BUTTON_TEXT = "com.playtang.commonnavigation.login.PlayTangLoginActivity.TWITTER_LOGIN_BUTTON_TEXT";

  // For internally serializing to/from string array (the public analog above is for resource from activity meta-data).
  private static final String FACEBOOK_LOGIN_PERMISSIONS_STRING_ARRAY = "com.playtang.commonnavigation.login.PlayTangLoginActivity.FACEBOOK_LOGIN_PERMISSIONS_STRING_ARRAY";

  private static final String LOG_TAG = "PlayTangLoginConfig";
  ...
  /**
   * Constructs a PlayTangLoginConfig object from a bundle. Unrecognized keys are
   * ignored.
   * <p/>
   * This can be used to pass an PlayTangLoginConfig object between activities, or
   * to read settings from an activity's meta-data in Manefest.xml.
   *
   * @param bundle
   *     The Bundle representation of the PlayTangLoginConfig object.
   * @param context
   *     The context for resolving resource IDs.
   * @return The PlayTangLoginConfig instance.
   */
  public static PlayTangLoginConfig fromBundle(Bundle bundle, Context context) {
    PlayTangLoginConfig config = new PlayTangLoginConfig();
