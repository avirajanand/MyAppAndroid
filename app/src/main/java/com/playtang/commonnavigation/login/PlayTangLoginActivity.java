 ...
 * {@link PlayTangLoginConfig} for available settings.</li>
 ...
 * <li>Using {@link PlayTangLoginBuilder} to construct an intent that can be used
 * to start this activity with your customizations.</li>
 * </ul>
 */
public class PlayTangLoginActivity extends FragmentActivity implements
        PlayTangLoginFragment.PlayTangLoginFragmentListener,
        PlayTangLoginHelpFragment.PlayTangOnLoginHelpSuccessListener,
        PlayTangOnLoginSuccessListener, PlayTangOnLoadingListener {

  public static final String LOG_TAG = "PlayTangLoginActivity";
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (savedInstanceState == null) {
      ...
      getSupportFragmentManager().beginTransaction().add(fragmentContainer,
              PlayTangLoginFragment.newInstance(configOptions)).commit();
    }
  }
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent data) {
    super.onActivityResult(requestCode, resultCode, data);
      Log.d(LOG_TAG, "PlaytangLoginActivity onActivityResult:" + requestCode + ":" + resultCode + ":" + data);
...
//data.
    ...
    if (requestCode == RC_SIGN_IN) {
      ...
      if (!mGoogleApiClient.isConnecting()) {
        mIsResolving = false;
        Toast.makeText(this, "onActivityResult trying to connect gplus ", Toast.LENGTH_LONG).show();
  ...
  public void onSignUpClicked(String username, String password) {
    ...
    transaction.replace(fragmentContainer,
            PlayTangSignupFragment.newInstance(configOptions, username, password));
  ...
  public void onLoginHelpClicked() {
    ...
    FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
    transaction.replace(fragmentContainer, PlayTangLoginHelpFragment.newInstance(configOptions));
    transaction.addToBackStack(null);
    transaction.commit();
  }
  ...
  public void onLoadingStart(boolean showSpinner) {
    if (showSpinner) {
      progressDialog = ProgressDialog.show(this, null,
          getString(com.playtang.commonnavigation.R.string.com_parse_ui_progress_dialog_text), true, false);
    }
  }
  ...
  protected void onSaveInstanceState(Bundle outState) {
    ...
    getMergedOptions().putAll(outState);
  }
}
